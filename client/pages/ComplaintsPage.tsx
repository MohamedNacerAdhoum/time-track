export default function ComplaintsPage() {
  return (
    <div>
      <h1 className="text-3xl font-bold text-black mb-6">Complaints</h1>
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <p className="text-gray-600">
          Complaints management functionality will be implemented here. This
          page will allow users to:
        </p>

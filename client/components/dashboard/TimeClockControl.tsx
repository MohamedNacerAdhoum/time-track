...
const TimeClockControl = () => {
  ...
  return (
    <div className="flex justify-center items-start gap-[60px] p-[9px_0] w-full">
      {/* Clock In */}
      <div className="flex flex-col items-center gap-5 w-[180px]">
        <button className="flex w-[150px] h-[44px] px-5 py-2.5 justify-center items-center gap-2.5 rounded-full bg-[#4DA64D] shadow-[-4px_4px_12px_0_rgba(0,0,0,0.25)] transition-transform hover:scale-105 active:scale-95">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-white font-semibold text-base font-poppins">Clock in</span>
          </div>
        </button>
        
        <div className="flex h-[120px] p-5 flex-col items-center gap-2.5 w-full rounded-[10px] bg-[rgba(77,166,77,0.2)]">
          <textarea
            value={notes.clockin}
          ...
          <div className="flex items-center gap-2 w-full">
            ...
            <span className="text-[#77838F] opacity-50 text-[11px] font-normal font-poppins">Note</span>
          </div>
        </div>
      </div>
      ...
      {/* Clock Out */}
      <div className="flex flex-col items-center gap-5 w-[180px]">
        <button className="flex w-[150px] h-[44px] px-5 py-2.5 justify-center items-center gap-2.5 rounded-full bg-[#FF6262] shadow-[-4px_4px_12px_0_rgba(0,0,0,0.25)] transition-transform hover:scale-105 active:scale-95">
          <div className="flex items-center gap-2.5">
            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="text-white font-semibold text-base font-poppins">Clock out</span>
          </div>
        </button>
        
        <div className="flex h-[120px] p-5 flex-col items-center gap-2.5 w-full rounded-[10px] bg-[rgba(255,98,98,0.2)]">
          <textarea

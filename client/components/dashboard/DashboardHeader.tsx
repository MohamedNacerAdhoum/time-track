      ...
      <div className="flex items-center gap-7 relative">
        ...
        <div className="relative">
          <button
            ...
            className="flex p-[3px] items-start gap-2.5 rounded-full border-[3px] border-[#4DA64D] relative"
          >
          ...
          {/* Profile Dropdown */}
          {isProfileDropdownOpen && (
            <div className="absolute top-full right-0 mt-2 w-36 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
              <div className="flex items-center gap-2 px-5 py-3 border-b border-gray-200 hover:bg-gray-50 cursor-pointer">

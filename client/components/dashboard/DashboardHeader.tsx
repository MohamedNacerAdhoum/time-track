      ...
      <div className="flex items-center bg-white relative">
        <div className="flex w-[126px] p-[8.64px] items-start gap-3 rounded-full border border-[#63CDFA]/50 bg-white relative">
          <button
            ...
            className={`flex px-[8.64px] py-[8.64px] justify-center items-center gap-[8.64px] flex-1 self-stretch rounded-full transition-all duration-200 ${!isAdminView ? "bg-[#63CDFA]" : "bg-transparent hover:bg-gray-50"
              } relative`}
          >
            <User
              className={`w-[30.24px] h-[30.24px] transition-colors ${!isAdminView ? "text-white" : "text-[#77838F]"}`}
            />
          </button>
          <button
            onClick={onToggleView}

  ...
  return (
    <div className="w-full px-4 py-2">
      ...
      <div className="flex md:hidden justify-center items-center gap-4 w-full">
        {/* Clock In - Mobile */}
        <button className="flex w-[96px] h-[40px] px-3 py-2 justify-center items-center gap-2 rounded-full bg-[#4DA64D] shadow-[-4px_4px_12px_0_rgba(0,0,0,0.25)] transition-transform hover:scale-105 active:scale-95">
        ...
        {/* Break - Mobile */}
        <button className="flex w-[96px] h-[40px] px-3 py-2 justify-center items-center gap-2 rounded-full bg-[#FFA501] shadow-[-4px_4px_12px_0_rgba(0,0,0,0.25)] transition-transform hover:scale-105 active:scale-95">
          <div className="flex items-center gap-2">
            <svg
              width="12"
              height="13"
        ...
        {/* Clock Out - Mobile */}
        <button className="flex w-[96px] h-[40px] px-3 py-2 justify-center items-center gap-2 rounded-full bg-[#FF6262] shadow-[-4px_4px_12px_0_rgba(0,0,0,0.25)] transition-transform hover:scale-105 active:scale-95">
          <div className="flex items-center gap-2">
            <svg
              width="12"
              height="12"
